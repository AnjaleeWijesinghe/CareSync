...
router.post('/', protect, authorise('patient', 'admin'), upload.single('photo'), createPatient);
router.get('/', protect, authorise('admin'), getAllPatients);
router.get('/:id', protect, authorise('patient', 'admin'), getPatient);
router.put('/:id', protect, authorise('patient', 'admin'), upload.single('photo'), updatePatient);
